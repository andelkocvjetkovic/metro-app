  ...
  return (
    <div className='inline-flex flex-col relative mt-4 w-52'>
      ...
      >
        ...
        <input {...inputProps} ref={inputRef} className='w-full outline-none px-3 py-1 appearance-none' />
        <button
          {...buttonProps}
          ref={clearButtonRef}
      ...
      {state.isOpen && (
        <Popover popoverRef={popoverRef} triggerRef={outerRef} state={state} isNonModal placement='bottom start' className='w-52'>
